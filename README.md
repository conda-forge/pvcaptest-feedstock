...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pvcaptest-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10204&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pvcaptest-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pvcaptest` can be installed with:

```
conda install pvcaptest
```

It is possible to list all of the versions of `pvcaptest` available on your platform with:
